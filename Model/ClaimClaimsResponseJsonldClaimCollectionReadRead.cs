...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class ClaimClaimsResponseJsonldClaimCollectionReadRead {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfClaimClaimsResponseJsonldClaimCollectionReadReadContext Context { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ClaimClaimsResponseJsonldClaimCollectionReadRead {\n");
