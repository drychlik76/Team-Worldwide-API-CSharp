...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class ShipmentNoteResourceJsonldShipmentNoteResourceJsonldShipmentCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfShipmentNoteResourceJsonldShipmentNoteResourceJsonldShipmentCreateContext Context { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ShipmentNoteResourceJsonldShipmentNoteResourceJsonldShipmentCreate {\n");
