...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class GetInvoiceInvoiceJsonldInvoiceItemGetRead {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfGetInvoiceInvoiceJsonldInvoiceItemGetReadContext Context { get; set; }
    ...
    public ShipperJsonldInvoiceItemGetRead Shipper { get; set; }
    ...
    public ConsigneeJsonldInvoiceItemGetRead Consignee { get; set; }
    ...
    public BillToJsonldInvoiceItemGetRead BillTo { get; set; }
    ...
    public List<InvoiceDetailJsonldInvoiceItemGetRead> InvoiceDetail { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class GetInvoiceInvoiceJsonldInvoiceItemGetRead {\n");
