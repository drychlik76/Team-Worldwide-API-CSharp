...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class RequestedDeliveryJsonldShipmentBookingCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfRequestedDeliveryJsonldShipmentBookingCreateContext Context { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class RequestedDeliveryJsonldShipmentBookingCreate {\n");
