...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class ShipmentGoodsJsonldShipmentBookingCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfShipmentGoodsJsonldShipmentBookingCreateContext Context { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ShipmentGoodsJsonldShipmentBookingCreate {\n");
