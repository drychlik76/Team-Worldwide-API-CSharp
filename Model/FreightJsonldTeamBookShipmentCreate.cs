...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class FreightJsonldTeamBookShipmentCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfFreightJsonldTeamBookShipmentCreateContext Context { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class FreightJsonldTeamBookShipmentCreate {\n");
