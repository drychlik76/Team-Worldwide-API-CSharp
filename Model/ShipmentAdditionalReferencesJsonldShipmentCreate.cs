...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class ShipmentAdditionalReferencesJsonldShipmentCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfShipmentAdditionalReferencesJsonldShipmentCreateContext Context { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ShipmentAdditionalReferencesJsonldShipmentCreate {\n");
