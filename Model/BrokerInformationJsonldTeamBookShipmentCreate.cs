...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class BrokerInformationJsonldTeamBookShipmentCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfBrokerInformationJsonldTeamBookShipmentCreateContext Context { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class BrokerInformationJsonldTeamBookShipmentCreate {\n");
