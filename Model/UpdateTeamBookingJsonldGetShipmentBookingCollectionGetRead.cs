...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class UpdateTeamBookingJsonldGetShipmentBookingCollectionGetRead {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfUpdateTeamBookingJsonldGetShipmentBookingCollectionGetReadContext Context { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class UpdateTeamBookingJsonldGetShipmentBookingCollectionGetRead {\n");
