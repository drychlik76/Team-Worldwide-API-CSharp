...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class RequestedPickupJsonldShipmentBookingCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfRequestedPickupJsonldShipmentBookingCreateContext Context { get; set; }
    ...
    /// <summary>
    ///               [R] Regular,              [S] Special,              [F] Customer Drop-Off,              [N] No Action          
    /// </summary>
    /// <value>              [R] Regular,              [S] Special,              [F] Customer Drop-Off,              [N] No Action          </value>
    [DataMember(Name="type", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "type")]
    public string RequestedPickupType { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class RequestedPickupJsonldShipmentBookingCreate {\n");
