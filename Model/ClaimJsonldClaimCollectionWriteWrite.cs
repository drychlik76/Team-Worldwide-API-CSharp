...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class ClaimJsonldClaimCollectionWriteWrite {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfClaimJsonldClaimCollectionWriteWriteContext Context { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ClaimJsonldClaimCollectionWriteWrite {\n");
