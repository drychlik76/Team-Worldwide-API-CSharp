...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class ShipmentJsonldShipmentBookingCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfShipmentJsonldShipmentBookingCreateContext Context { get; set; }
    ...
    public ShipperJsonldShipmentBookingCreate Shipper { get; set; }
    ...
    public ConsigneeJsonldShipmentBookingCreate Consignee { get; set; }
    ...
    public AnyOfShipmentJsonldShipmentBookingCreateBillTo BillTo { get; set; }
    ...
    public AnyOfShipmentJsonldShipmentBookingCreateRequestedPickup RequestedPickup { get; set; }
    ...
    public AnyOfShipmentJsonldShipmentBookingCreateRequestedDelivery RequestedDelivery { get; set; }
    ...
    public List<ShipmentGoodsJsonldShipmentBookingCreate> ShipmentGoods { get; set; }
    ...
    public List<ShipmentGoodsHandlingJsonldShipmentBookingCreate> ShipmentGoodsHandling { get; set; }
    ...
    public List<ShipmentNoteResourceJsonldShipmentBookingCreate> ShipmentNotes { get; set; }
    ...
    public List<ShipmentAdditionalReferencesJsonldShipmentBookingCreate> AdditionalReferences { get; set; }
    ...
    public List<ProjectedExpenseJsonldShipmentBookingCreate> ProjectedExpenses { get; set; }
    ...
    public List<ProjectedCustomerChargeJsonldShipmentBookingCreate> ProjectedCustomerCharges { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ShipmentJsonldShipmentBookingCreate {\n");
