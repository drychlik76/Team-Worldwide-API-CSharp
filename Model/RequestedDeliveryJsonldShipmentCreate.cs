...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class RequestedDeliveryJsonldShipmentCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfRequestedDeliveryJsonldShipmentCreateContext Context { get; set; }
    ...
    [DataMember(Name="type", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "type")]
    public string RequestedDeliveryType { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class RequestedDeliveryJsonldShipmentCreate {\n");
