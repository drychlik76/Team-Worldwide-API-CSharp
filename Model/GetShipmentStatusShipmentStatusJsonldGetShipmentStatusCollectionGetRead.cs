...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class GetShipmentStatusShipmentStatusJsonldGetShipmentStatusCollectionGetRead {
    /// <summary>
    /// Gets or Sets Id
    /// </summary>
    ...
    public OneOfGetShipmentStatusShipmentStatusJsonldGetShipmentStatusCollectionGetReadContext Context { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class GetShipmentStatusShipmentStatusJsonldGetShipmentStatusCollectionGetRead {\n");
