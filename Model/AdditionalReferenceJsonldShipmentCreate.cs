...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class AdditionalReferenceJsonldShipmentCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfAdditionalReferenceJsonldShipmentCreateContext Context { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class AdditionalReferenceJsonldShipmentCreate {\n");
