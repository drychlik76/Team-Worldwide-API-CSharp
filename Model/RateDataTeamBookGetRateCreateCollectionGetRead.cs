...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class RateDataTeamBookGetRateCreateCollectionGetRead {
    /// <summary>
    /// Gets or Sets RateId
    /// </summary>
    ...
    public List<RateBreakDownTeamBookGetRateCreateCollectionGetRead> RateBreakDownList { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class RateDataTeamBookGetRateCreateCollectionGetRead {\n");
