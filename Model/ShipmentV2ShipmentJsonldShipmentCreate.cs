...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class ShipmentV2ShipmentJsonldShipmentCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfShipmentV2ShipmentJsonldShipmentCreateContext Context { get; set; }
    ...
    public ShipperJsonldShipmentCreate Shipper { get; set; }
    ...
    public ConsigneeJsonldShipmentCreate Consignee { get; set; }
    ...
    public AnyOfShipmentV2ShipmentJsonldShipmentCreateBillTo BillTo { get; set; }
    ...
    public AnyOfShipmentV2ShipmentJsonldShipmentCreateRequestedPickup RequestedPickup { get; set; }
    ...
    public AnyOfShipmentV2ShipmentJsonldShipmentCreateRequestedDelivery RequestedDelivery { get; set; }
    ...
    public List<ShipmentGoodsJsonldShipmentCreate> ShipmentGoods { get; set; }
    ...
    public List<ShipmentGoodsHandlingJsonldShipmentCreate> ShipmentGoodsHandling { get; set; }
    ...
    public List<ShipmentNoteResourceJsonldShipmentCreate> ShipmentNotes { get; set; }
    ...
    public List<ShipmentAdditionalReferencesJsonldShipmentCreate> AdditionalReferences { get; set; }
    ...
    public List<ProjectedExpenseJsonldShipmentCreate> ProjectedExpenses { get; set; }
    ...
    public List<ProjectedCustomerChargeJsonldShipmentCreate> ProjectedCustomerCharges { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ShipmentV2ShipmentJsonldShipmentCreate {\n");
