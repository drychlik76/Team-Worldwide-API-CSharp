...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class RequestedPickupJsonldShipmentCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfRequestedPickupJsonldShipmentCreateContext Context { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class RequestedPickupJsonldShipmentCreate {\n");
