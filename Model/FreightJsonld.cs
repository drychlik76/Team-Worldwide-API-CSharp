...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class FreightJsonld {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfFreightJsonldContext Context { get; set; }
    ...
    /// </summary>
    /// <value>Unique id is assigned to each freight info. This is readable only</value>
    ...
    /// <summary>
    /// Gets or Sets Dangerous
    /// </summary>
    [DataMember(Name="dangerous", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "dangerous")]
    public bool? Dangerous { get; set; }

    /// <summary>
    /// Gets or Sets FreightAsPrimusDataStructure
    /// </summary>
    [DataMember(Name="freightAsPrimusDataStructure", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "freightAsPrimusDataStructure")]
    public List<string> FreightAsPrimusDataStructure { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  FreightAsPrimusDataStructure: ").Append(FreightAsPrimusDataStructure).Append("\n");
      sb.Append("}\n");
      return sb.ToString();
    }
