...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class ShipmentV2ShipmentCreatedJsonld {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfShipmentV2ShipmentCreatedJsonldContext Context { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ShipmentV2ShipmentCreatedJsonld {\n");
