...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class BookShipmentJsonldTeamBookShipmentCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfBookShipmentJsonldTeamBookShipmentCreateContext Context { get; set; }
    ...
    public TeamBookShipperJsonldTeamBookShipmentCreate TeamBookShipper { get; set; }
    ...
    public TeamBookConsigneeJsonldTeamBookShipmentCreate TeamBookConsignee { get; set; }
    ...
    public AnyOfBookShipmentJsonldTeamBookShipmentCreateBrokerInformation BrokerInformation { get; set; }
    ...
    public PickupJsonldTeamBookShipmentCreate Pickup { get; set; }
    ...
    public AnyOfBookShipmentJsonldTeamBookShipmentCreateDelivery Delivery { get; set; }
    ...
    public List<FreightJsonldTeamBookShipmentCreate> Freight { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class BookShipmentJsonldTeamBookShipmentCreate {\n");
