...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class ShipmentBookingV2JsonldShipmentBookingCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfShipmentBookingV2JsonldShipmentBookingCreateContext Context { get; set; }
    ...
    public List<ShipmentJsonldShipmentBookingCreate> Shipments { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ShipmentBookingV2JsonldShipmentBookingCreate {\n");
