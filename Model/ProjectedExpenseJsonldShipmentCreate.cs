...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class ProjectedExpenseJsonldShipmentCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfProjectedExpenseJsonldShipmentCreateContext Context { get; set; }
    ...
    [DataMember(Name="type", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "type")]
    public string ProjectExpenseType { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ProjectedExpenseJsonldShipmentCreate {\n");
