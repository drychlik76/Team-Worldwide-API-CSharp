...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class DeliveryJsonldTeamBookShipmentCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfDeliveryJsonldTeamBookShipmentCreateContext Context { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class DeliveryJsonldTeamBookShipmentCreate {\n");
