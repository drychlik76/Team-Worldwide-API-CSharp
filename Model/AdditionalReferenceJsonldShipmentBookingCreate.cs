...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class AdditionalReferenceJsonldShipmentBookingCreate {
    /// <summary>
    /// Gets or Sets Context
    /// </summary>
    [DataMember(Name="@context", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "@context")]
    public OneOfAdditionalReferenceJsonldShipmentBookingCreateContext Context { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class AdditionalReferenceJsonldShipmentBookingCreate {\n");
