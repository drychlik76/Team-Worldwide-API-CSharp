...
namespace TeamWorldwideModel {
  ...
  /// </summary>
  [DataContract]
  public class ShipmentShipmentBookingCreate {
    /// <summary>
    ...
    public ShipperShipmentBookingCreate Shipper { get; set; }
    ...
    public ConsigneeShipmentBookingCreate Consignee { get; set; }
    ...
    public AnyOfShipmentShipmentBookingCreateBillTo BillTo { get; set; }
    ...
    public AnyOfShipmentShipmentBookingCreateRequestedPickup RequestedPickup { get; set; }
    ...
    public AnyOfShipmentShipmentBookingCreateRequestedDelivery RequestedDelivery { get; set; }
    ...
    public List<ShipmentGoodsShipmentBookingCreate> ShipmentGoods { get; set; }
    ...
    public List<ShipmentGoodsHandlingShipmentBookingCreate> ShipmentGoodsHandling { get; set; }
    ...
    public List<ShipmentNoteResourceShipmentBookingCreate> ShipmentNotes { get; set; }
    ...
    public List<ShipmentAdditionalReferencesShipmentBookingCreate> AdditionalReferences { get; set; }
    ...
    public List<ProjectedExpenseShipmentBookingCreate> ProjectedExpenses { get; set; }
    ...
    public List<ProjectedCustomerChargeShipmentBookingCreate> ProjectedCustomerCharges { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ShipmentShipmentBookingCreate {\n");
